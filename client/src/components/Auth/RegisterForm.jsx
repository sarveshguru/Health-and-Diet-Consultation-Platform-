          ...
          <CardContent>
            ...
            <form onSubmit={handleRegister}>
              <TextField
                ...
                InputLabelProps={{
                  sx: {
                    color: "#fff", // White when not focused or shrunk
                    [`&.${inputLabelClasses.shrink}`]: {
                      color: "#fff", // White when focused or shrunk
                    },
                  },
                }}
                InputProps={{
                  // Add InputProps to style the input element itself
                  sx: {
                    color: "#fff", // Input text color white
                    "&.Mui-focused": {
                      // Targeted the focused state of the input root
                      backgroundColor: "transparent", // Set background to transparent or your desired color
                      // or
                      // backgroundColor: "your_desired_background_color_on_focus",
                    },
                  },
                }}
              />
