  ...
  return (
    <Box p={4}>
      ...
      <Box sx={{ display: "flex", gap: 4, mb: 3, flexWrap: "wrap" }}>
        <Box sx={{ minWidth: 160, p: 2, bgcolor: "#f5f6fa", borderRadius: 2,boxShadow: " 0 1px 4px rgba(0,0,0,0.89)" }}>
        ...
        return (
          <Paper
            ...
            sx={{
              ...
              boxShadow: urgent ? "0 0 20px 2px #ffe0b2" : 3,
...
const DieticianAppointments = () => {
  ...
  return (
    <Box p={4}>
      ...
      <Box sx={{ display: "flex", gap: 4, mb: 3, flexWrap: "wrap" }}>
        <Box sx={{ minWidth: 160, p: 2, bgcolor: "#f5f6fa", borderRadius: 2 }}>
          <Typography variant="subtitle2" color="text.secondary">
            Today
          </Typography>
          <Typography variant="h6" color="primary.main">
        ...
        return (
          <Paper
            ...
            sx={{
              ...
              mb: 3,
              border: urgent ? "2px solid #ff9800" : undefined,
              boxShadow: urgent ? "0 0 10px 2px #ffe0b2" : 3,
              background: urgent ? "#fff8e1" : "#fff",
              transition: "all 0.2s",
            }}
            elevation={urgent ? 6 : 3}
