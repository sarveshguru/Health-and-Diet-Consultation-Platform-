...
const UserDashboard = () => {
  ...
  return (
    ...
    >
      ...
      <Grid container spacing={{ xs: 2, sm: 3, md: 4 }} mb={{ xs: 2, sm: 3, md: 4 }}>
        <Grid item xs={12} sm={6} md={6} lg={3}>
          <DataCard
            label="Weight"
            value={getLatest(userDetails?.weight)}
            unit="kg"
            icon={<FitnessCenterIcon sx={{ color: "#3f51b5", fontSize: { xs: 32, sm: 36, md: 40 } }} />}
            editable
        ...
        <Grid item xs={12} sm={6} md={6} lg={3}>
          <DataCard
            ...
            unit="cm"
            icon={<StraightenIcon sx={{ color: "#43a047", fontSize: { xs: 32, sm: 36, md: 40 } }} />}
            editable
        ...
        <Grid item xs={12} sm={6} md={6} lg={3}>
          <DataCard
            label="BMI"
            value={bmi}
            icon={<MonitorWeightIcon sx={{ color: "#fbc02d", fontSize: { xs: 32, sm: 36, md: 40 } }} />}
          />
        </Grid>
        <Grid item xs={12} sm={6} md={6} lg={3}>
          <DataCard
            ...
            unit="Ltr"
            icon={<LocalDrink sx={{ color: "#0288d1", fontSize: { xs: 32, sm: 36, md: 40 } }} />}
            editable
